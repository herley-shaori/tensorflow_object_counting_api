...
input_video = "./input_images_and_videos/1.JPG"

targeted_objects = "motorcycle" # (for counting targeted objects) change it with your targeted objects
...
result = object_counting_api.single_image_object_counting(input_video, detection_graph, category_index, is_color_recognition_enabled,targeted_objects) # targeted objects counting
